...
<td>Nama Sekolah</td>
<td>
<input class="form-control" type="text" name="nama_sekolah" id="nama_sekolah" value="<?php echo"$row[nama_sekolah]";?>" required="" minwidth="3" maxwidth="50"><input class="form-control "  type="hidden" id="id" name="id" value="<?php echo"$row[id]";?>"/>
</td>
</tr>
<tr>
