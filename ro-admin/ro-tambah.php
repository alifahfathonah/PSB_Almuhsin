...
<h4 class="panel-title" style="text-transform: uppercase;">TAMBAH SANTRI</h4>
</div>
...
<a data-toggle="collapse" data-parent="#accordion" href="#collapseSatu">DATA SANTRI #1</a>
</h4>
</div>
...
<input  class="form-control" placeholder="Nama Santri" id="nama_siswa" name="nama_siswa" maxlength="30" minlength="3" required="" value="<?php echo $nama_siswa; ?>" />
</div>
<div class="form-group">
...
<textarea id="alamat_siswa" name="alamat_siswa" class="form-control" maxlength="100" minlength="3" rows="3" required="" placeholder="Masukan ALamat Santri"><?php echo $alamat_siswa;?></textarea>
</div>
<div class="form-group">
<label>No. Hp Santri : </label>
<input class="form-control" type="text" name="hp_siswa" id="hp_siswa" maxlength="12" min="12" placeholder="Masukan No Hp Santri" onkeypress="return Angkasaja(event)" required="" value="<?php echo $hp_siswa;?>" />
</div>
